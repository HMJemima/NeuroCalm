...
const MOCK_HISTORY = [
  ...
  { id: '2', filename: 'clinical_trial_fnirs_005.edf', created_at: ago(DAY * 1), stress_score: 38, confidence: 90, user_name: 'Dr. Sarah Admin', user_email: 'admin@neurocalm.com' },
  ...
  { id: '7', filename: 'fnirs_recording_001.mat', created_at: ago(HOUR * 1), stress_score: 28, confidence: 92, user_name: 'John Doe', user_email: 'user@neurocalm.com' },
  ...
  { id: '13', filename: 'monday_commute_fnirs.mat', created_at: ago(DAY * 10), stress_score: 58, confidence: 87, user_name: 'John Doe', user_email: 'user@neurocalm.com' },
  ...
  { id: '21', filename: 'patient_fnirs_014.edf', created_at: ago(DAY * 3), stress_score: 82, confidence: 92, user_name: 'Dr. Michael Ross', user_email: 'mross@clinic.com' },
  { id: '22', filename: 'sleep_onset_fnirs.edf', created_at: ago(DAY * 6), stress_score: 19, confidence: 93, user_name: 'Dr. Michael Ross', user_email: 'mross@clinic.com' },
